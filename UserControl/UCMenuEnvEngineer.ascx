<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCMenuEnvEngineer.ascx.vb" Inherits="CFMISNew.UCMenuEnvEngineer" %>
...
<asp:SiteMapDataSource ID="smdsrcSearch" runat="server" SiteMapProvider="SiteMap3" />
