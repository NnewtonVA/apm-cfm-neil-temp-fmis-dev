<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCMenuSustainability.ascx.vb" Inherits="CFMISNew.UCMenuSustainability" %>
...
<asp:SiteMapDataSource ID="smdsrcSearch" runat="server" SiteMapProvider="SiteMap5" />
