...
Public Class ProjectDetails
    ...
    Protected Sub SetControlsEnabledDisabled()
        ...
        End If
        If rdRegisteredOnline.Enabled = True And rdRegisteredOnline.SelectedValue = "No" Then
            txtLeedRegistration.Enabled = True
        Else
            txtLeedRegistration.Enabled = False
        End If
    ...
    Private Sub GetSustainabilityGenInfo()
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            Else
                txtSqFtRenovation.Text = "0"
            End If
            txtSqFtAll.Text = Convert.ToInt32(ds.Tables(0).Rows(0)("SquareFootageConstructionWork").ToString) + Convert.ToInt32(ds.Tables(0).Rows(0)("SquareFootageRenovationWork").ToString)
    ...
    Protected Sub addSqFt()
        ...
        If txtSqFtRenovation.Text = String.Empty Then
            txtSqFtRenovation.Text = 0
        End If
        txtSqFtAll.Text = (Convert.ToInt32(txtSqFtConst.Text) + Convert.ToInt32(txtSqFtRenovation.Text)).ToString
    End Sub
    ...
    Private Sub GetSustainabilityASHRAE()
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            End If
            If ds.Tables(0).Rows(0)("isDesignCostEffective").ToString <> String.Empty Then
                rdoCostEffective.SelectedValue = ds.Tables(0).Rows(0)("isDesignCostEffective").ToString
            End If
            If ds.Tables(0).Rows(0)("AshraeNotCostEffectiveExplain").ToString <> String.Empty Then
    ...
    Private Sub SaveGenInfo()
        ...
        Using conn As New SqlConnection(ConnStr)
            ...
            Else
                command.Parameters.AddWithValue("@SquareFootageConstructionWork", DbNullOrStringValue(Convert.ToInt32(txtSqFtConst.Text)))
            End If
            ...
            If txtSqFtConst.Text = String.Empty Then
                sqftConst = 0
            Else
                sqftConst = Convert.ToInt32(txtSqFtConst.Text)
            End If
            If txtSqFtRenovation.Text = String.Empty Then
                sqftRenovation = 0
            Else
                sqftRenovation = Convert.ToInt32(txtSqFtRenovation.Text)
            End If
    ...
    Private Sub SaveLeeds()
        ...
        Using conn As New SqlConnection(ConnStr)
            ...
            'If leeds required is set to know all the other leeds control are disabled-see rdoLEEDRequired click event
            If rdRegisteredOnline.Enabled = False Then
            ...
            End If
            If rdoProjectedLeedSilver.Enabled = False Then
                command.Parameters.AddWithValue("@isProjectedMinLEEDsilverCert", DBNull.Value)
            Else
                command.Parameters.AddWithValue("@isProjectedMinLEEDsilverCert", DbNullOrStringValue(rdoProjectedLeedSilver.Text.ToString()))
            End If

            If rdoLeedWaiver.Enabled = False Then
            ...
            If rdoCertStatus.Enabled = False Then
            ...
            If txtDateCertifed.Enabled = False Then
            ...
            If ddLEEDCertLevelAcheived.Enabled = False Then
