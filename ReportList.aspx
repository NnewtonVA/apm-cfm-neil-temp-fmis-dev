<%@ Page Title="Active Reports" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ReportList.aspx.vb" Inherits="CFMISNew.ReportList" %>
            ...
            <div class="wideBox" style="padding-left:15px; height: 241px;">
                ...
                <table style="border: thin none #000080; height: 80px; width: 98%;">
                    ...
                    <tr><td class="auto-style4">
                        <asp:HyperLink ID="hlVhaReport" runat="server" Text="Active report for VHA" Font-Bold="True" NavigateUrl="~/ReportViewerActive.aspx?report=ActiveReport_VHA"></asp:HyperLink>
                    </td><td class="auto-style5">

                    </td></tr><tr><td class="auto-style4">
                        <asp:HyperLink ID="hlNcaReport" runat="server" Text="Active report for NCA" Font-Bold="True"  NavigateUrl="~/ReportViewerActive.aspx?report=ActiveReport_NCA"></asp:HyperLink>
                    </td><td class="auto-style5">
